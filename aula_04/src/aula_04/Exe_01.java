...
public class Exe_01 {
	...
	public static void main(String[] args) {
		...
		int idade, identidadegenero, mulherC = 0, homemC = 0, naob = 0, mulherT = 0, homemT = 0, outros = 0;
		...
		while (continua.equalsIgnoreCase("S")) {
			...
			System.out.println("O número de Homens Cis e Trans desenvolvedores Mobile maiores de 40 anos:" + homemC
					+ homemT + mobile);
			System.out.println(
					"O número de Não Binários desenvolvedores FullStack menores de 30 anos:" + naob + fullstack);
